...
string buku[50];
int kode[50], nomor[50], harga[50], hargatotal, jumlah[50], banyak[11],subtotal[50];
int i=0;
int pmbyrn;
char reglog;
struct tanggal{
...
void pinjam(){
	int  back;
				...
				system("cls");
				daftar();
				cout<<"Masukkan jumlah judul Buku Yang Ingin Dipinjam\t: ";cin>>i;
				for (int a=0;a<i;a++) {
				//memilih kode buku
			    cout<<"\nMasukkan Kode Buku Ke "<<a+1<<" : ";cin>>kode[i];
			    if (kode[i]==11) {
			    	harga[i]=3100;
				}
				else if (kode[i]==14) {
				...
				//memilih judul buku
				cout<<"Masukkan Nomor Buku "<<a+1<<" : ";cin>>nomor[i];
				if (nomor[i]==1){
					buku[i]="ANTARES";
					if (kode[i]!=11) {
						cout<<"\nMaaf Nomor Buku Yang Anda Masukkan Tidak Ada di Daftar Kode Buku "<<kode[i]<<endl;
						system("pause");
						system("cls");
						goto masukkode;
					}
					...
					buku[i]="KEBANGKITAN MALARANGGENG";
					if (kode[i]!=14) {
						cout<<"\nMaaf Nomor Buku Yang Anda Masukkan Tidak Ada di Daftar Kode Buku "<<kode[i]<<endl;
						system("pause");
						system("cls");
					...
					buku[i]="Cara Jitu Menjadi Tiktokers";
					if (kode[i]!=36) {
						cout<<"\nMaaf Nomor Buku Yang Anda Masukkan Tidak Ada di Daftar Kode Buku "<<kode[i]<<endl;
						system("pause");
						system("cls");
				...
				cout<<"Jumlah Buku "<<buku[i]<<" Yang Dipinjam\t: ";cin>>jumlah[i];
				subtotal[i]=jumlah[i]*harga[i];
				hargatotal=hargatotal+subtotal[i];
			}
				...
				for (int a=0;a<i;a++) {
				cout<<"\n Judul Buku Ke "<<a+1<<" : "<<buku[a];
				cout<<"\n Kode Buku ke "<<a+1<<" : "<<kode[a];
				cout<<"\n Nomor Buku ke "<<a+1<<" : "<<nomor[a];
				}
